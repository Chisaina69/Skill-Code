...
function Student() {
  ...
  return (
    <div className="flex flex-col h-screen" style={backgroundStyle}>
      ...
      <div className="flex-1 p-4 text-center bg-gray-100 bg-opacity-75">
        ...
        <Link to="/trials" className="bg-blue-500 hover-bg-blue-700 text-white font-semibold py-2 px-6 rounded">
          Try It Out
        </Link>
      </div>
    </div>
